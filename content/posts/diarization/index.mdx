...
> This blog post is based on the work done by [Anirudh Dagar](https://github.com/AnirudhDagar) as an intern at
Vernacular.ai
...
<audio controls="controls">
    <source src="./ExampleAudioBackgroundTalking.wav" />
</audio>
...
<audio controls="controls">
    <source src="./ExampleAudioBBQ.wav" />
</audio>
