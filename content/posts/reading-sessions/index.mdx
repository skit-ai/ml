...
readings, practical disconnects and difference in interests start to
...
-   Make sure people are going away with a healthy amount of *thought
    food*.
-   Nudge towards the *utilitarian aspects* of the ideas presented so
    that audience follow a few threads of experimentation.

## People

With people, we can think in the following terms[^1]:
...
-   Level of comfort with group sessions. Both for presentation and
    discussion.
-   Bandwidth. This becomes specially important in industrial settings
    like ours.
...
a team at a given moment of time, but even a minimal set is sufficiently
diverse. The key idea is accept a pluralistic view on the issue. There
is no *single* fundamentally correct way of doing these sessions, and
it's better to pick a digestible subset and solve for that.
...
many others. For example you can't just bring in any new paper and
...
Each of these has a plan of what's supposed to be discussed over a
period of 1-2 months. While not perfect, these are developing in decent
reading roadmap for the topics. Something we would like to open out
after a couple of months, similar to what we did with the old style
